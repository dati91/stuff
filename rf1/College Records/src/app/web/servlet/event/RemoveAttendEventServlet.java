...
public class RemoveAttendEventServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		if(service.login(username, password)){
			...
			Attend a = service.getAttend(id);
			if(a != null && (a.getUsername().equals(username) || service.isAdmin(username))){
				service.removeAttend(id);
			}
